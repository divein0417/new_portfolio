...
<script type="text/javascript">
	var naver_id_login = new naver_id_login("NzPA7U8YSlZhljGrKf1r", "https://<?=$_SERVER['HTTP_HOST']?><?=$_SERVER['PHP_SELF']?>");
...
<!-- //네이버아디디로로그인 초기화 Script -->
	<form name="lfrm" id="lfrm" action="/member/sns_naver_login.php" method="POST">
