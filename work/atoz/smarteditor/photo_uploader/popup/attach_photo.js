    ...
    function html5Upload() {
    	...
    	sUploadURL= 'http://www.bornto.co.kr/smarteditor/photo_uploader/popup/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sUrl  : 'http://www.bornto.co.kr/smarteditor/photo_uploader/popup/file_uploader.php',	//샘플 URL입니다.
